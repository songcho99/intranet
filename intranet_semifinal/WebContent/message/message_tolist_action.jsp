...
<%
	...
	String mreader = request.getParameter("mreader");
	String mreaderdel = "mreaderdel";
	System.out.println("mreader="+mreader);
	//페이지 영역
	   ...
	   //총 글의 개수 구하기
	   totalCount = msdao.getFromMessageCount(mreaderdel, mreader,category,searchtxt,num);
	...
	List<MessageDto> mslist = msdao.getFromMessageList(mreader,category,searchtxt,start,end,num);
