...
<%
	...
	System.out.println(category+","+searchtxt+","+pageNum);
	...
	//페이지 영역
	   ...
	   //총 글의 개수 구하기
	   totalCount = dao.getMyBoardTotalCount(category,searchtxt,num);
	...
	List<BoardDto> list=dao.getAllAdminBoard(num,category,searchtxt,start,end);
