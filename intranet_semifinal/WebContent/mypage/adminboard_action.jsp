...
<%
	...
	System.out.println("category:"+category+",searchtxt:"+searchtxt+",pageNum="+pageNum);
	...
	//페이지 영역
	   ...
	   //총 글의 개수 구하기
	   totalCount = dao.getMyBoardTotalCount(category,searchtxt,null);
	...
	List<BoardDto> list=dao.getAllAdminBoard(null,category,searchtxt,start,end);
